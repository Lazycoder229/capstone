    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="w-[280px] max-w-[85vw] bg-sidebar p-0 text-sidebar-foreground flex flex-col h-full shadow-2xl"
          side={side}
        >
    ...
    >
      ...
      >
        <div
          ...
          className="flex size-full flex-col bg-sidebar border-r border-sidebar-border group-data-[variant=floating]:border-0 group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1 group-data-[variant=floating]:ring-sidebar-border"
        >
          {children}
        </div>
      </div>
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn("h-10 w-10 sm:h-8 sm:w-8 shrink-0", className)}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
      {...props}
    >
      <PanelLeftIcon className="h-5 w-5 sm:h-4 sm:w-4" />
